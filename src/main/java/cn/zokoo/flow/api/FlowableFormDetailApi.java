 ...
 */
@RestController
@RequestMapping("/api/rest/formdetail")
public class FlowableFormDetailApi extends BaseController {
    private static final Logger LOGGER = LoggerFactory.getLogger(FlowableFormDetailApi.class);
    @Autowired
