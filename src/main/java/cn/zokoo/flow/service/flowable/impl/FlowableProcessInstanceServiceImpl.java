...
import cn.zokoo.flow.mapper.flowable.FlowableProcessInstanceMapper;
import cn.zokoo.flow.cmd.processinstance.DeleteFlowableProcessInstanceCmd;
...
import cn.zokoo.flow.service.flowable.FlowableBpmnModelService;
...
public class FlowableProcessInstanceServiceImpl extends BaseProcessService implements FlowableProcessInstanceService {
    ...
    public PagerModel<ProcessInstanceVo> getPagerModel(ProcessInstanceQueryVo params, Query query) {
        ...
        Page<ProcessInstanceVo> page = flowableProcessInstanceMapper.getPagerModel(params);
    ...
    public PagerModel<ProcessInstanceVo> getMyProcessInstances(ProcessInstanceQueryVo params, Query query) {
        ...
        if (StringUtils.isNotBlank(params.getUserCode())) {
            Page<ProcessInstanceVo> myProcesses = flowableProcessInstanceMapper.getPagerModel(params);
