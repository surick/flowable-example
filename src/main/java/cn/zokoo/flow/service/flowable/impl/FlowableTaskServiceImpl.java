...
import cn.zokoo.flow.mapper.flowable.FlowableTaskMapper;
...
public class FlowableTaskServiceImpl extends BaseProcessService implements FlowableTaskService {
    ...
    public PagerModel<TaskVo> getApplyingTasks(TaskQueryVo params, Query query) {
        ...
        Page<TaskVo> applyingTasks = flowableTaskMapper.getApplyingTasks(params);
    ...
    public PagerModel<TaskVo> getApplyedTasks(TaskQueryVo params, Query query) {
        PageHelper.startPage(query.getPageNum(), query.getPageSize());
        Page<TaskVo> applyedTasks = flowableTaskMapper.getApplyedTasks(params);
